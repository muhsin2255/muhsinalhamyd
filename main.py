...
class ActivationScreen(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.add_widget(GradientLabel(
            text=reshape("نظام إدارة الكميات", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(30),
            size_hint_y=None,
            height=dp(60),
        ...
        self.status_label = GradientLabel(
            text=reshape("الحالة: جاري التحقق...", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(24),
            color=(0.8, 0.5, 0, 1),
            size_hint_y=None,
            height=dp(50),
    ...
    def show_progress_popup(self):
        ...
        content.add_widget(Label(
            text=reshape("جاري انتظار رد المسؤول...", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(20)
        ))
        
        self.progress_label = Label(
            text=reshape("تم إرسال طلب التفعيل إلى المسؤول", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(18)
        )
...
class MilkRecordsViewer(BoxLayout):
    ...
    def build_ui(self, *args):
        ...
        # عنوان الشاشة
        self.add_widget(GradientLabel(
            text=reshape("السجلات المحفوظة", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(24),
            size_hint_y=None,
            height=dp(60),
            gradient=GRADIENT_BLUE
    ...
    def load_records(self):
        ...
        if not os.path.exists(records_dir):
            ...
            self.records_layout.add_widget(Label(
                text=reshape("لا توجد سجلات محفوظة بعد", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                font_name="ArabicFont",
                font_size=dp(20),
                size_hint_y=None,
                height=dp(50),
    ...
    def show_record_content(self, filename):
        ...
        try:
            ...
            # عنوان الملف
            self.add_widget(GradientLabel(
                text=reshape(f"سجل: {filename}", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                font_size=dp(22),
                size_hint_y=None,
                height=dp(50),
                gradient=GRADIENT_BLUE
            ...
            scroll = ModernScrollView()
            content_label = Label(
                text=reshape(content, font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                font_name="ArabicFont",
                font_size=dp(18),
                size_hint_y=None,
                halign="right",
    ...
    def confirm_delete_all(self, instance):
        content = BoxLayout(orientation='vertical', spacing=dp(10), padding=dp(20))
        content.add_widget(Label(
            text=reshape("هل أنت متأكد من حذف جميع السجلات؟", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(20),
            color=(0, 0, 0, 1)  # لون النص أسود ليكون واضحًا
        ))
    ...
    def build_ui(self):
        ...
        if activation.is_activated():
            ...
            if info:
                ...
                if remaining_days <= 5:
                    warning_label = Label(
                        text=reshape(f"⚠️ انتبه! لقد بقي {remaining_days} أيام لانتهاء التفعيل", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                        font_name="ArabicFont",
                        font_size=dp(16),
                        color=(1, 0, 0, 1),
                        size_hint_y=None,
                    ...
                    days_label = Label(
                        text=reshape(f"الأيام المتبقية: {remaining_days} يوم", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                        font_name="ArabicFont",
                        font_size=dp(16),
                        color=(0, 0.6, 0, 1),
                        size_hint_y=None,
...
الرجاء إضافتهم أولاً.""", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
    ...
    def build_ui(self):
        ...
        name_label = GradientLabel(
            text=reshape(self.names[self.index], font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(18),
            size_hint_y=None,
            height=dp(30),
            gradient=GRADIENT_BLUE
        ...
        for i, mat in enumerate(mat_list):
            fields.add_widget(Label(
                text=reshape(mat, font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                font_name="ArabicFont",
                font_size=dp(21),
                size_hint_y=None,
                height=dp(35),
    ...
    def preview_screen(self):
        ...
        for name in self.names:
            ...
            box.add_widget(GradientLabel(
                text=reshape(name, font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                font_size=dp(20),
                size_hint_y=None,
                height=dp(30),
                gradient=GRADIENT_BLUE
        ...
        layout.add_widget(GradientLabel(
            text=reshape("المجاميع النهائية:", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(20),
            size_hint_y=None,
            height=dp(35),
            gradient=GRADIENT_BLUE
...
class NameEditorLayout(BoxLayout):
    ...
    def main_menu(self):
        self.clear_root()
        self.add_widget(GradientLabel(
            text=reshape("قائمة الخيارات", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(22),
            size_hint_y=None,
            height=dp(40),
            gradient=GRADIENT_BLUE
    ...
    def add_new_name(self):
        self.clear_root()
        self.add_widget(Label(
            text=reshape("أدخل اسم الزبون", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(20),
            size_hint_y=None,
            height=dp(40),
    ...
    def modify_existing(self):
        self.clear_root()
        self.add_widget(Label(
            text=reshape("اختر اسماً للتعديل", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(20),
            size_hint_y=None,
            height=dp(40),
    ...
    def delete_name(self):
        self.clear_root()
        self.add_widget(Label(
            text=reshape("اختر اسماً للحذف", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(20),
            size_hint_y=None,
            height=dp(40),
    ...
    def confirm_delete(self, name):
        ...
        content.add_widget(Label(
            text=reshape(f"هل أنت متأكد من حذف '{name}'؟", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(22),
            color=(0, 0, 0, 1)  # لون النص أسود ليكون واضحًا
        ))
    ...
    def manage_materials(self):
        self.clear_root()
        self.add_widget(GradientLabel(
            text=reshape("إدارة المواد", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(22),
            size_hint_y=None,
            height=dp(40),
            gradient=GRADIENT_BLUE
        ...
        self.add_widget(Label(
            text=reshape("إضافة مادة جديدة:", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(18),
            size_hint_y=None,
            height=dp(30),
        ...
        self.add_widget(Label(
            text=reshape("حذف مادة موجودة:", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(18),
            size_hint_y=None,
            height=dp(30),
        ...
        for material in self.materials:
            row = BoxLayout(size_hint_y=None, height=dp(50), spacing=dp(10))
            row.add_widget(Label(
                text=reshape(material, font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                font_name="ArabicFont",
                font_size=dp(18),
                size_hint_x=0.7,
                color=(0, 0, 0, 1)
    ...
    def add_new_material(self, instance):
        ...
        if new_material and new_material not in self.materials:
            content = BoxLayout(orientation='vertical', spacing=dp(20), padding=dp(20))
            content.add_widget(Label(
                text=reshape(f"اختر نوع المادة '{new_material}'", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                font_name="ArabicFont",
                font_size=dp(22),
                color=(0, 0, 0, 1)  # لون النص أسود ليكون واضحًا
            ))
    ...
    def get_material_weight(self, material, prev_popup):
        ...
        content = BoxLayout(orientation='vertical', spacing=dp(20), padding=dp(20))
        content.add_widget(Label(
            text=reshape(f"أدخل وزن الوحدة للمادة '{material}' (كجم, font_name='fonts/ArabicFont.ttf', halign='right', valign='top')"),
            font_name="ArabicFont",
            font_size=dp(22),
            color=(0, 0, 0, 1)  # لون النص أسود ليكون واضحًا
        ))
    ...
    def confirm_delete_material(self, material):
        content = BoxLayout(orientation='vertical', padding=dp(20), spacing=dp(20))
        content.add_widget(Label(
            text=reshape(f"هل أنت متأكد من حذف '{material}'؟", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_name="ArabicFont",
            font_size=dp(22),
            color=(0, 0, 0, 1)  # لون النص أسود ليكون واضحًا
        ))
    ...
    def show_all(self):
        self.clear_root()
        self.add_widget(GradientLabel(
            text=reshape("جميع الزبائن والمواد", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
            font_size=dp(20),
            size_hint_y=None,
            height=dp(40),
            gradient=GRADIENT_BLUE
        ...
        for name in self.names:
            ...
            for mat in self.name_materials.get(name, []):
                box.add_widget(Label(
                    text=reshape(f"\u2022 {mat}", font_name='fonts/ArabicFont.ttf', halign='right', valign='top'),
                    font_name="ArabicFont",
                    font_size=dp(16),
                    color=(0, 0, 0, 1),
                    size_hint_y=None,
